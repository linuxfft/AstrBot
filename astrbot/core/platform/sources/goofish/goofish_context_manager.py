...
class GoofishChatContextManager:
    """
    聊天上下文管理器
    ...
    def __init__(self, max_history=100, db_path="data/goofish_chat_history.db"):
        """
        初始化聊天上下文管理器
    ...
    def save_item_info(self, item_id, item_data):
        ...
        try:
            ...
            cursor.execute(
                ...
                DO
                UPDATE SET data = ?, price = ?, description = ?, last_updated = ?
                """,
                (
    ...
    def get_context_by_chat(self, chat_id) -> list[str] | None:
        """
        基于会话ID获取对话历史
    ...
    def increment_bargain_count_by_chat(self, chat_id):
        ...
        try:
            ...
            cursor.execute(
                ...
                DO
                UPDATE SET count = count + 1, last_updated = ?
                """,
